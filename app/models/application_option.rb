...
class ApplicationOption < ApplicationRecord
  ...
  validates :question_type, presence: { error: 'ERR_BLANK', description: "Attribute can't be blank" },
                            inclusion: { in: %w[yes_no text link single_choice multiple_choice], error: 'ERR_INVALID', description: 'Attribute is invalid' }
