...
#   # @return [void]
#   def send_notification_employer(employer_name, employer_email, applicant_name, applicant_email, user_id, job_id,
#                                  applied_at, content = '', documents = '')
...
#       an>#{applied_at}
#       #{
#             "<br><span style=3D\"color:#636367\">Content: </span>#{content}" unless content.eql? ''}
#
#       #{
#             unless documents.eql? ''
...
#   # @return [void]
#   def send_notification_applicant(applicant_name, applicant_email, job_id, _comment)
