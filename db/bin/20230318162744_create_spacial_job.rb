...
class CreateSpacialJob < ActiveRecord::Migration[7.0]
  def change
    create_enum :job_status, %w[public private archieved]
    create_table :jobs_spacial, primary_key: :job_id, id: :integer, charset: 'unicode', force: :cascade do |t|
      enable_extension 'postgis'
      t.st_point :job_value, geographic: true, has_z: true
      # t.string :job_type
