...
RSpec.describe 'JobsController' do
  before(:all) do
    ...
    params = { 'grant_type' => 'refresh_token', 'refresh_token' => @valid_rt }
    ...
    params = { 'grant_type' => 'refresh_token', 'refresh_token' => @unsubscribed_rt }
    post('/api/v0/auth/token/access', params:)
    ...
    describe '(POST: /api/v0/jobs)' do
      ...
      context 'invalid inputs' do
        ...
        it 'returns [400 Bad Request] for invalid description' do
          post('/api/v0/jobs',
               params: form_data.merge(description: 'a' * 10_001), headers:)
          expect(response).to have_http_status(400)
        end
