    ...
    describe '(GET: /api/v0/client/subscriptions/{id})' do
      context 'valid normal inputs' do
        it 'returns [200 Ok] and user JSON' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          get("/api/v0/client/subscriptions/#{@subscription.id}", headers:)
          expect(response).to have_http_status(200)
        end
      end
      context 'invalid inputs' do
        ...
        it 'returns [404 Not Found] for trying to access someone else\'s submission' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          get("/api/v0/client/subscriptions/#{@forbidden_subscription.id}", headers:)
          expect(response).to have_http_status(404)
        end
        it 'returns [404 Not Found] for non existing subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          get("/api/v0/client/subscriptions/#{@subscription.id + 1}", headers:)
          expect(response).to have_http_status(404)
        end
      end
    end
    ...
    describe '(POST: /api/v0/client/subscriptions)' do
      context 'valid normal inputs' do
        it 'returns [201 Created] and creates new subscription' do
          body = { subscription: { tier: 'basic', active: true, expiration_date: '2024-11-19T06:16:09.000Z',
                                   start_date: '2024-11-19T06:16:09.000Z', auto_renew: true } }
          post '/api/v0/client/subscriptions', params: body.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
      ...
      context 'invalid inputs' do
        ...
        it 'returns [400 Bad Request] for missing tier' do
          body = { subscription: { active: true, expiration_date: '2024-11-19T06:16:09.000Z',
                                   start_date: '2024-11-19T06:16:09.000Z', auto_renew: true } }
          post '/api/v0/client/subscriptions', params: body.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
          expect(response).to have_http_status(400)
        ...
        it 'returns [400 Bad Request] for missing active' do
          body = { subscription: { tier: 'basic', expiration_date: '2024-11-19T06:16:09.000Z',
                                   start_date: '2024-11-19T06:16:09.000Z', auto_renew: true } }
          post '/api/v0/client/subscriptions', params: body.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
          expect(response).to have_http_status(400)
        ...
        it 'returns [400 Bad Request] for missing expiration date' do
          body = { subscription: { tier: 'basic', active: true, start_date: '2024-11-19T06:16:09.000Z',
                                   auto_renew: true } }
          post '/api/v0/client/subscriptions', params: body.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
          expect(response).to have_http_status(400)
        ...
        it 'returns [400 Bad Request] for missing auto renew' do
          body = { subscription: { tier: 'basic', active: true, expiration_date: '2024-11-19T06:16:09.000Z',
                                   start_date: '2024-11-19T06:16:09.000Z' } }
          post '/api/v0/client/subscriptions', params: body.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
          expect(response).to have_http_status(400)
        end
        it 'returns [400 Bad Request] for invalid tier' do
          body_1 = { subscription: { tier: 'test123', active: true, expiration_date: '2024-11-19T06:16:09.000Z',
                                     start_date: '2024-11-19T06:16:09.000Z', auto_renew: true } }
          body_2 = { subscription: { tier: '', active: true, expiration_date: '2024-11-19T06:16:09.000Z',
                                     start_date: '2024-11-19T06:16:09.000Z', auto_renew: true } }
          body_3 = { subscription: { tier: nil, active: true, expiration_date: '2024-11-19T06:16:09.000Z',
                                     start_date: '2024-11-19T06:16:09.000Z', auto_renew: true } }
          post '/api/v0/client/subscriptions', params: body_1.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
          expect(response).to have_http_status(400)
          post '/api/v0/client/subscriptions', params: body_2.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
          expect(response).to have_http_status(400)
          post '/api/v0/client/subscriptions', params: body_3.to_json,
                                               headers: { 'Content-Type' => 'application/json', 'HTTP_ACCESS_TOKEN' => @valid_access_token }
          expect(response).to have_http_status(400)
        end
      end
    ...
    describe '(PATCH: /api/v0/client/subscriptions/{id}/activate)' do
      context 'valid normal inputs' do
        it 'returns [200 Ok] and activates subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          patch("/api/v0/client/subscriptions/#{@subscription.id}/activate", headers:)
          expect(response).to have_http_status(200)
        end
      end
      context 'invalid inputs' do
        ...
        it 'returns [404 Not Found] for trying to activate someone else\'s submission' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          patch("/api/v0/client/subscriptions/#{@forbidden_subscription.id}/activate", headers:)
          expect(response).to have_http_status(404)
        end
        it 'returns [404 Not Found] for non existing subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          patch("/api/v0/client/subscriptions/#{@subscription.id + 1}/renew", headers:)
          expect(response).to have_http_status(404)
        end
      end
    end
    ...
    describe '(PATCH: /api/v0/client/subscriptions/{id})/renew' do
      context 'valid normal inputs' do
        it 'returns [200 Ok] and renews subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          patch("/api/v0/client/subscriptions/#{@subscription.id}/renew", headers:)
          expect(response).to have_http_status(200)
        end
      end
      context 'invalid inputs' do
        ...
        it 'returns [404 Not Found] for trying to renew someone else\'s submission' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          patch("/api/v0/client/subscriptions/#{@forbidden_subscription.id}/renew", headers:)
          expect(response).to have_http_status(404)
        end
        it 'returns [404 Not Found] for non existing subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
    ...
    describe '(PATCH: /api/v0/client/subscriptions/{id})/cancel' do
      context 'valid normal inputs' do
        it 'returns [200 Ok] and cancels subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          patch("/api/v0/client/subscriptions/#{@subscription.id}/cancel", headers:)
          expect(response).to have_http_status(200)
        end
      end
      context 'invalid inputs' do
        ...
        it 'returns [404 Not Found] for trying to cancel someone else\'s submission' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          patch("/api/v0/client/subscriptions/#{@forbidden_subscription.id}/cancel", headers:)
          expect(response).to have_http_status(404)
        end
        it 'returns [404 Not Found] for non existing subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
    ...
    describe '(DELETE: /api/v0/client/subscriptions/{id})' do
      context 'valid normal inputs' do
        it 'returns [200 Ok] and deletes subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          delete("/api/v0/client/subscriptions/#{@subscription.id}", headers:)
          expect(response).to have_http_status(200)
        end
      end
      context 'invalid inputs' do
        ...
        it 'returns [404 Not Found] for trying to delete someone else\'s submission' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          delete("/api/v0/client/subscriptions/#{@forbidden_subscription.id}", headers:)
          expect(response).to have_http_status(404)
        end
        it 'returns [404 Not Found] for non existing subscription' do
          headers = { 'HTTP_ACCESS_TOKEN' => @valid_at_has_subscriptions }
          delete("/api/v0/client/subscriptions/#{@subscription.id + 1}", headers:)
          expect(response).to have_http_status(404)
        end
      end
    end
